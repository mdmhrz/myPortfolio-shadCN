                ...
                {projects.map((project, index) => {
                    ...
                    return (
                        ...
                        >
                            ...
                            <div className={`flex flex-col lg:flex-row ${isEven ? "lg:flex-row-reverse" : ""} gap-8 lg:gap-12 bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-lg dark:shadow-gray-900/30 border border-gray-100 dark:border-gray-700`}>
                                {/* Image container */}
